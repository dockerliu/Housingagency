...
namespace build
{
    public partial class zufangchaxun : Form
    {
        public zufangchaxun()
        {
            InitializeComponent();
        ...
        private void zufangchaxun_Load(object sender, EventArgs e)
        {
            string sql = "select area from area";
            DataTable dd = data.Query(sql);
            this.comboBox10.DataSource = dd;
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    sql = sql + "area='" + this.comboBox10.Text + "' and ";
                }
                ...
                {
                    sql = sql + "lend_price>='" + textBox3.Text + "' and ";
                }
                if (this.textBox4.Text != "")
                {
                    sql = sql + "lend_price<='" + textBox4.Text + "' and ";
                }
